...
- Xiaohongshu's original-declaration control defaults to off. The manual panel must display the expected off state, and the user must visually verify it before publishing; any visible enabled state blocks publication.
